...
Select * 
From Covid_Portfolioproject..Covid_deaths
order by 3,4

--Select * 
--from Covid_Portfolioproject..Covid_vaccinations
--order by 3,4
...
Select *
From Covid_Portfolioproject..Covid_deaths deaths
Join Covid_Portfolioproject..Covid_vaccinations vacc
